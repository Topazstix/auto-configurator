# Generated by Powerlevel10k configuration wizard on 2021-06-19 at 20:15 MDT.
...
() {
  ...
  ## change tun to proton for it to match protonvpn
  ...
  # Custom icon.
  ## Uncomment for revolutionary status comrade ¯\_(ツ)_/¯ ☭
  ...
  # Failed function :(
  # ## Function for showing cpu temp
  # function prompt_cpu_temp() {
  #   integer cpu_temp="$(</sys/class/thermal/thermal_zone0/temp) / 1000"
  #   if (( cpu_temp >= 80 )); then
  #     p10k segment -s HOT -f red -t "${cpu_temp}°C"
  #   elif (( cpu_temp >= 60 )); then
  #     p10k segment -s WARM -f yellow -t "${cpu_temp}°C"
  #   fi
  # }
  # POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS+=prompt_cpu_temp
